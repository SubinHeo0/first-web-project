...
<!-- 						</thead> -->
						<tbody>
							<tr>
								...
								<td><input type="text" class="form-control" name="subject" value="${dto.subject }" required></td>
							</tr>
							<tr>
								<td style="padding: 5.2em; text-align: center;">내용</td>
								<td><textarea class="form-control" rows="10" name="content" required>${dto.content }</textarea> </td>
							</tr>
						</tbody>
					</table>
