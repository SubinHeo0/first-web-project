		...
		<div class="container clearfix">
			<div class="content col-lg-12 col-md-12 col-sm-12 clearfix">
				<div class="col-lg-6 col-md-6 col-sm-12">
					...
					<p class="withpadding">
						Still not registered? <a href="#">Click Here</a> to register now.
					</p>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-12">
					<h4 class="title">
					...
					<form id="loginform" action="./MemberLoginAction.me" method="post" name="loginform">
						...
						<div class="form-group pull-right">
							...
							<button type="button" class="button" onclick="location.href='./MemberJoin.me';">회원가입</button>
						</div>
					</form>
				</div>
				<!-- end login -->
